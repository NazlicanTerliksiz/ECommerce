...
class SearchProductsAdapter(
    ...
    RecyclerView.Adapter<SearchProductsAdapter.SearchProductRowHolder>() {
    private val searchProductList = ArrayList<ProductUI>()

    inner class SearchProductRowHolder(private val binding: ItemViewSearchProductsBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SearchProductRowHolder {
        val binding =
            ItemViewSearchProductsBinding.inflate(
                LayoutInflater.from(parent.context),
                parent,
                false
            )
        return SearchProductRowHolder(binding)
    }
    ...
    override fun onBindViewHolder(holder: SearchProductRowHolder, position: Int) {
